...
export class FollowerController {
  ...
  async listFollower(
    ...
    const data = await this.followerService.listFollower(
      listFollowerDto,
      account,
    );
    return {
  ...
  async listFollowed(
    ...
    const data = await this.followerService.listFollowed(
      listFollowedDto,
      account,
    );
    return {
  ...
  async showFollowerDetail(
    ...
    const data = await this.followerService.showFollowerDetail(ref, account);
    return {
      data: data,
      message: 'Détails du follower obtenus avec succès',
      code: HttpStatus.OK,
    };
  }
}
